...
禅道项目管理软件(ZenTaoPMS)是一款国产的，基于LGPL协议，开源免费的项目管理软件，它集产品线管理、项目管理、测试管理于一体，同时还包含了事务管理、组织管理等诸多功能，是中小型企业项目管理的首选。
...
$lang->install->groupList['PO']['name']     = '产品线经理';
$lang->install->groupList['PO']['desc']     = '产品线经理';
$lang->install->groupList['TD']['name']     = '研发主管';
$lang->install->groupList['TD']['desc']     = '研发主管';
$lang->install->groupList['PD']['name']     = '产品线主管';
$lang->install->groupList['PD']['desc']     = '产品线主管';
