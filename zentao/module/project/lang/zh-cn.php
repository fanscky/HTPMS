...
$lang->project->manageProducts   = '关联产品线';
...
$lang->project->ajaxGetProducts  = '接口：获得项目产品线列表';
...
$lang->project->aboveAllProduct = '以上所有产品线';
...
$lang->project->oneLineStats    = "项目<strong>%s</strong>, 代号为<strong>%s</strong>, 相关产品线为<strong>%s</strong>，<strong>%s</strong>开始，<strong>%s</strong>结束，总预计<strong>%s</strong>工时，已消耗<strong>%s</strong>工时，预计剩余<strong>%s</strong>工时。";
...
$lang->project->whyNoStories    = "看起来没有需求可以关联。请检查下项目关联的产品线中有没有需求，而且要确保它们已经审核通过。";
...
$lang->project->errorNoLinkedProducts = '该项目没有关联的产品线，系统将转到产品线关联页面';
...
$lang->project->linkProduct           = '选择产品线关联...';
