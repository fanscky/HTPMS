...
$lang->zentaoPMS      = '硬件項目測試管理系統';
$lang->welcome        = "硬件項目測試管理系統";
$lang->myControl      = "我的地盤";
...
$lang->bug->menu->testtask = array('link' => '版本&執行|testtask|browse|productID=%s');
...
$lang->testcase->menu->testtask = array('link' => '版本&執行|testtask|browse|productID=%s', 'alias' => 'view,create,edit,linkcase,cases,start,close,batchrun,groupcase');
