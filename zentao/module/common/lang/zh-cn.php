...
$lang->zentaoPMS      = '硬件项目测试管理系统';
$lang->welcome        = "硬件项目测试管理系统";
$lang->myControl      = "我的地盘";
...
$lang->menu->product  = '产品线|product|index';
...
$lang->index->menu->product = '浏览产品线|product|browse';
...
$lang->product->menu->create  = array('link' => '<i class="icon-plus"></i>&nbsp;添加产品线|product|create', 'float' => 'right');
$lang->product->menu->all     = array('link' => '<i class="icon-th"></i>&nbsp;所有产品线|product|index|locate=no&productID=%s', 'float' => 'right');
...
$lang->project->menu->product   = '产品线|project|manageproducts|projectID=%s';
...
$lang->bug->menu->testtask = array('link' => '版本&执行|testtask|browse|productID=%s');
...
$lang->testcase->menu->testtask = array('link' => '版本&执行|testtask|browse|productID=%s', 'alias' => 'view,create,edit,linkcase,cases,start,close,batchrun,groupcase');
...
$lang->report->menu->product = array('link' => '产品线|report|productinfo');
