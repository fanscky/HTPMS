...
$lang->action->trashTips      = '提示：为了保证系统的完整性，硬件项目测试管理系统的删除都是标记删除。';
...
$lang->action->objectTypes['product']     = '产品线';
$lang->action->objectTypes['story']       = '需求';
$lang->action->objectTypes['productplan'] = '产品线计划';
...
/* 用来生成相应对象的链接。*/
$lang->action->label->product     = '产品线|product|view|productID=%s';
...
$lang->action->search->objectTypeList['product']     = '产品线';    
