...
$lang->bug->allProduct     = '所有产品线';
$lang->bug->ditto          = '同上';

/* 页面标签。*/
$lang->bug->lblProductAndModule         = '产品线模块';
$lang->bug->lblProjectAndTask           = '项目任务';
$lang->bug->lblStory                    = '相关需求';
$lang->bug->lblTypeAndSeverity          = '类型/严重程度';
$lang->bug->lblSystemBrowserAndHardware = '来源/引入阶段';
...
/* 交互提示。*/
$lang->bug->confirmChangeProduct = '修改产品线会导致相应的项目、需求和任务发生变化，确定吗？';
...
$lang->bug->osList['']        = '';
$lang->bug->osList['sdv'] = 'SDV测试';
$lang->bug->osList['sit']    = 'SIT测试';
$lang->bug->osList['svt']    = 'SVT测试';
$lang->bug->osList['debug']   = '调试';
$lang->bug->osList['integration']   = '集成测试';
$lang->bug->osList['review'] = '评审';
$lang->bug->osList['production'] = '生产用软件测试';
$lang->bug->osList['pilotplant'] = '中试';
$lang->bug->osList['profession'] = '专业试验';
$lang->bug->osList['admittance'] = '准入测试';
...
$lang->bug->browserList['Planning']       = '企划阶段';
$lang->bug->browserList['master']     = '总体规划阶段';
$lang->bug->browserList['single']     = '各单板设计实现阶段';
$lang->bug->browserList['Simulation']      = '集成阶段';
$lang->bug->browserList['Internaltest']      = '内部测试阶段';
$lang->bug->browserList['Prototype']      = '样机评审阶段';
$lang->bug->browserList['volume']      = '首量阶段';
$lang->bug->browserList['end']   = '项目结束阶段';
