...
$lang->admin->welcome = '欢迎使用硬件项目测试管理系统后台管理';

$lang->admin->browseCompany = '浏览公司';

$lang->admin->info = new stdclass();
$lang->admin->info->caption = '硬件项目测试管理系统信息';
$lang->admin->info->version = '当前系统的版本是%s，';
$lang->admin->info->links   = '您可以访问以下链接：';
$lang->admin->info->account = "您的社区账户为%s。";

$lang->admin->notice = new stdclass();
$lang->admin->notice->register = "友情提示：您还未在社区登记，%s进行登记，以及时获得硬件项目测试管理系统最新信息。";
$lang->admin->notice->ignore   = "不再提示";

$lang->admin->register = new stdclass();
$lang->admin->register->caption    = '社区登记';
