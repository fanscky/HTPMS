...
$lang->story->sourceList['po']         = '产品线经理';
...
$lang->story->specTemplate          = "建议参考的模板：主要有<i class='text-important'>一、需求来源（写明需求来源文档、信息、截图）</i>；<i class='text-important'>二、需求类型</i>；<i class='text-important'>三、规格描述</i>。<br>验收标准主要描述产品测试规格和验收办法";
...
$lang->story->ajaxGetProductStories = '接口:获取产品线需求列表';
...
$lang->story->report->charts['storysPerProduct']        = '产品线需求数量';
...
$lang->story->report->storysPerProduct->item      = '产品线';     
...
$lang->story->report->storysPerProduct->graph->xAxisName      = '产品线';
$lang->story->report->storysPerModule->graph->xAxisName       = '模块';
$lang->story->report->storysPerSource->graph->xAxisName       = '来源';
$lang->story->report->storysPerPlan->graph->xAxisName         = '产品线计划';
