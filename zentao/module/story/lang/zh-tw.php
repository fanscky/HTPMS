...
$lang->story->specTemplate          = "建議參考的模板：主要有<i class='text-important'>一、需求來源（寫明需求來源文檔、信息、截圖）</i>；<i class='text-important'>二、需求類型</i>；<i class='text-important'>三、規格描述</i>。<br>驗收標準主要描述產品測試規格和驗收辦法";
