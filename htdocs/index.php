...
$lang->cn->links['zentao']['text']       = '开始登陆';
$lang->cn->links['zentao']['target']     = '_self';

$lang->cn->title = '【硬件项目测试管理系统】';
$lang->cn->xampp      = " <a href='http://www.ruijie.net/' target='_blank'>研究院内网</a>";
$lang->cn->official   = " <a href='http://www.ruijie.com.cn/' target='_blank'>锐捷网络官网</a>";
...
$lang->en->links['zentao']['text']       = 'Login';
$lang->en->links['zentao']['target']     = '_self';

$lang->en->title      = 'Welcome to use ruijie PMS!';
$lang->en->xampp      = " <a href='http://www.ruijie.net/' target='_blank'>Local</a> ";
$lang->en->official   = " <a href='http://www.ruijie.com.cn/' target='_blank'>Community</a>";
